...
//
// Run against any Educare install by setting LAUNCH_URL:
...
module.exports = {
  default: {
    ...
    format: [
      ...
      // version via package.json overrides (npm) + resolutions (yarn); the JSON
      // report below is what the HTML/PDF report is generated from.
    ...
    worldParameters: {
      ...
      minWaitTime: {
        // Per-navigation settle budget. Educare is built on Varbase (Gin admin

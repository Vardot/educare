...
/**
 * @file
 * Wires a plain Drupal CMS project for the Educare site template.
 *
...
const SITE_TEMPLATE_NAME = 'educare';
const SITE_TEMPLATE_TITLE = 'Educare';
const SITE_TEMPLATE_PACKAGE = 'drupal/educare';
...
⚠️  Known limit: on a plain Drupal CMS base use `drush site:install`. Picking the
   ...
   template's control and is not specific to Educare.
";
